...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Hello_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Hello_t qt_meta_stringdata_Hello = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Hello[] = {
...
Q_CONSTINIT const QMetaObject Hello::staticMetaObject = { {
    ...
    qt_meta_stringdata_Hello.offsetsAndSizes,
    qt_meta_data_Hello,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Hello_t,
        // Q_OBJECT / Q_GADGET
